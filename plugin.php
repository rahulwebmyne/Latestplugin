...
function github_plugin_updater_test_init() {
	...
	if ( is_admin() ) { // note the use of is_admin() to double check that this is happening in the admin
		...
		$config = array(
			...
			'api_url' => 'https://api.github.com/repos/rahulwebmyne/Latestplugin',
			'raw_url' => 'https://raw.githubusercontent.com/rahulwebmyne/Latestplugin/master',
			'github_url' => 'https://github.com/rahulwebmyne/Latestplugin',
