...
function github_plugin_updater_test_init() {
	...
	if ( is_admin() ) { // note the use of is_admin() to double check that this is happening in the admin
		...
		$config = array(
			...
			'api_url' => 'https://api.github.com/repos/rahulwebmyne/newpluginupdate',
			'raw_url' => 'https://raw.githubusercontent.com/rahulwebmyne/newpluginupdate/master',
			'github_url' => 'https://github.com/rahulwebmyne/newpluginupdate',
			'zip_url' => 'https://github.com/rahulwebmyne/newpluginupdate/archive/master.zip',
			'sslverify' => false,
			'requires' => '3.8.2',
			'tested' => '5.4',
			'readme' => 'README.md',
